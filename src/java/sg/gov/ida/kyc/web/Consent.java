...
import sg.gov.ida.kyc.service.ConsentService;
...
public class Consent extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(uid!=null&&!uid.isEmpty())
        {
            ...
            String reqOrg = emp.getBank().getName();
            String name = request.getParameter("name");
            String owner = request.getParameter("owner");
            ConsentService consentSvc = new ConsentService();
            consentSvc.createNew(uid, name, owner, emp.getBank());
            page="/customerList";
        }
